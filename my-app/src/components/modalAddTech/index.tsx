...
interface IFunctionAddTech {
  closeModalAddTech: () => void;
}

const ModalTech = ({ closeModalAddTech }: IFunctionAddTech) => {
  const { register, handleSubmit } = useForm();
  const { addTech, setUpdate, loading, setLoading }: any =
        ...
        <div>
          ...
          <form onSubmit={handleSubmit(addTech)}>
            ...
            <div>
              ...
              <select id="stats" {...register("status")}>
